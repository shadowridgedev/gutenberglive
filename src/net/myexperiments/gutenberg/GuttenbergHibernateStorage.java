...
import net.myexperiments.gutenberg.Book;
...
public class GuttenbergHibernateStorage {
	...
	List<Book> returnBooks() {
		newSession = factory.openSession();
		newSession.beginTransaction();
		Query<Book> q = newSession.createNativeQuery("SELECT * FROM guttenberg.book").addEntity(net.myexperiments.gutenberg.Book.class);
